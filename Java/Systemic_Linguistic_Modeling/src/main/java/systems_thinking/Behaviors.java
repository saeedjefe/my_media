...
public interface Behaviors {
    ...
    void balanceOrientedBehavior(BalanceOrientedTerms balanceOrientedTerms);
    void changeOrientedBehavior(ChangeOrientedTerms changeOrientedTerms);
    void integrationBehavior(IntegrationBehaviorTerms integrationBehaviorTerms);
    void feedbackControlBehavior(FeedbackControlTerms feedbackControlTerms);
    void resilienceOrientedBehavior(ResilienceOrientedTerms resilienceOrientedTerms);
